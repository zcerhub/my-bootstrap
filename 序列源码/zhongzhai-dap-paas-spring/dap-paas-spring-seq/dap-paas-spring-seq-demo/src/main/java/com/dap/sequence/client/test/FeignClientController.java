...
public class FeignClientController {
    ...
    public ResultResponse getStringSequence(@PathVariable("seqCode") String seqCode, @RequestParam(required = false) String sign) {
        ...
        //            String seq = sequenceGeneratorClient.getVariableSequence(seqCode, sign, place);
        //            stopWatch.stop();
        //            LOGGER.warn("获取序号【{}】时间消耗：{}", seq, stopWatch.getTotalTimeMillis());
        //        } catch (SequenceException e) {
        //            LOGGER.error("获取序列报错:{}", e.getMessage());
     ...
     * @return ResultResponse
     */
    @RequestMapping(value = "getStringSequenceDatePlaceholder/{seqCode}", method = RequestMethod.GET)
    public ResultResponse getStringSequenceDatePlaceholder(@PathVariable("seqCode") String seqCode) {
        ResultResponse resultResponse;
        try {
            StopWatch stopWatch = new StopWatch();
            stopWatch.start();
            String sequence = sequenceGeneratorClient.getStringSequenceWithDatePlaceholder(seqCode,new Date());
            stopWatch.stop();
            LOGGER.warn("获取序号【{}】时间消耗：{}", sequence, stopWatch.getTotalTimeMillis());
            resultResponse = ResultResponse.success(sequence);
        } catch (SequenceException e) {
     ...
     * @return ResultResponse
     */
    @RequestMapping(value = "getRecoverySequenceDatePlaceholder/{seqCode}", method = RequestMethod.GET)
    public ResultResponse getRecoverySequenceDatePlaceholder(@PathVariable("seqCode") String seqCode) {
        ResultResponse resultResponse;
        try {
            StopWatch stopWatch = new StopWatch();
            stopWatch.start();
            String sequence = sequenceGeneratorClient.getRecoverySequenceWithDatePlaceholder(seqCode,new Date());
            stopWatch.stop();
            LOGGER.warn("获取回收序号【{}】时间消耗：{}", sequence, stopWatch.getTotalTimeMillis());
            resultResponse = ResultResponse.success(sequence);
        } catch (SequenceException e) {
     ...
     * @return ResultResponse
     */
    @RequestMapping(value = "getDaySwitchSequenceDatePlaceholder/{seqCode}", method = RequestMethod.GET)
    public ResultResponse getDaySwitchSequenceDatePlaceholder(@PathVariable("seqCode") String seqCode) {
        ResultResponse resultResponse;
        try {
            StopWatch stopWatch = new StopWatch();
            stopWatch.start();
            String sequence = sequenceGeneratorClient.getDaySwitchSequenceWithDatePlaceholder(seqCode, new Date(),true);
            stopWatch.stop();
            LOGGER.warn("取消回拨序号【{}】时间消耗：{}", sequence, stopWatch.getTotalTimeMillis());
            resultResponse = ResultResponse.success(sequence);
        } catch (SequenceException e) {
    ...
    public ResultResponse getDaySwitchSequenceDate(@PathVariable("seqCode") String seqCode, @RequestParam String date) {
        ...
        try {
            ...
            StopWatch stopWatch = new StopWatch();
            stopWatch.start();
            String sequence = sequenceGeneratorClient.getDaySwitchSequence(seqCode, date1);
            stopWatch.stop();
            LOGGER.warn("取消回拨序号【{}】时间消耗：{}", sequence, stopWatch.getTotalTimeMillis());
            resultResponse = ResultResponse.success(sequence);
        } catch (SequenceException e) {
