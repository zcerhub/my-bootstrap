package com.dap.paas.console.common.encrypt.des;

import com.dap.paas.console.common.encrypt.HexUtils;
...
public class DesUtil {
	 ...
	 * DES 加密
	 */
	private String keyStr = "Dvxchuy8qwertnBk";// 密钥
	private String iv = "12345678";// iv加密向量
	private String algorithm = "DESede/CBC/PKCS7Padding";// 填充方式(加密方式)DESede/CBC/PKCS5Padding和 DESede/CBC/PKCS7Padding
	...
	public String encrypt(String strIn) throws Exception {
		...
		Cipher encryptCipher = Cipher.getInstance(algorithm);
		encryptCipher.init(Cipher.ENCRYPT_MODE, getKey(keyStr), ivspec);
		return HexUtils.toHexString(encrypt(strIn.getBytes(charset)));
	}
