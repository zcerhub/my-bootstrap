...
public class JschOperator {
     ...
     */
    public ShellResult execute(final String command) throws Exception {
        int shellExitStatus = 0;
        ShellResult shellResult;
        try {
        	openChannel(JschOperator.CHANNEL_EXEC);
     ...
     * @throws Exception 异常
     */
    public File download(final String sourceFile, final String targetFile)
            throws Exception {
    	openChannel(JschOperator.CHANNEL_SFTP);
...
//            List<String> list = formatPath(sourceFile);
     ...
     * @throws Exception 异常
     */
    private void uploadFile(final String srcFile, final String dir, final String fileName)
            throws Exception {
    ...
    public void uploadFile(final String sourceFileAbsolutePath, final String targetPath) throws Exception {
        try {
            ...
            if (file.exists()) {
             //   String fileName = getFileName(sourceFileAbsolutePath);
     ...
     */
    public void mkdirs(final String dir) throws Exception {
    	openChannel(JschOperator.CHANNEL_SFTP);
        ChannelSftp channelSftp = (ChannelSftp) this.channel;
...
//        }
    ...
    public static void main(String[] args) throws Exception {
    	JschOperator jr = new JschOperator("10.114.14.66", "mq" , "mq" , 22);
        jr.openSession();
        String cmd = "sh /home/rocketmq/app/dap-clients/workspace//rocketmq-4.9.1/bin/mqbroker -c /home/rocketmq/app/dap-clients/workspace/rocketmq-4.9.1/conf/RocketMQ_Broker/10911//broker.properties -n 10.64.6.126:9876";
        ShellResult s = jr.executeExec(cmd);
        

        System.out.println("返回：");
        System.out.println(s.getShellOutPut());
        jr.close();
	}
}
