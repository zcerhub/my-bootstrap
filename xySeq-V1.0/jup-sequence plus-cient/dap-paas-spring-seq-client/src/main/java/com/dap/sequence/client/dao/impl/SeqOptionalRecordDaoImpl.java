...
public class SeqOptionalRecordDaoImpl extends AbstractBaseDaoImpl<SeqOptionalRecord, String> implements SeqOptionalRecordDao {
    ...
    @Override
    public Integer saveOptional(SeqOptionalRecord seqOptionalRecord) {
        return this.getSqlSession().insert(getSqlNamespace() + "." + "saveOptional", seqOptionalRecord);
    }
    ...
    @Override
    public SeqOptionalRecord selectOneRecord(SeqOptionalRecord optionalRecord) {
        return this.getSqlSession().selectOne(getSqlNamespace() + "." + "selectOneRecord", optionalRecord);
    }
}
