...
import com.dap.sequence.client.core.SeqFlowEngine;
...
public abstract class AbstractSeqFlowEngine implements SeqFlowEngine {
    ...
    private AtomicReference<LocalSeqProducer> seqProducer;
    ...
    public void setSeqProducer(AtomicReference<LocalSeqProducer> seqProducer) {
        this.seqProducer = seqProducer;
    }

    public AtomicReference<LocalSeqProducer> getSeqProducer() {
        return seqProducer;
    }
