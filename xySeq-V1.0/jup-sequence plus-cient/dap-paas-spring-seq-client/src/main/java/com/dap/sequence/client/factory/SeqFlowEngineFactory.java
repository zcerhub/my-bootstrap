package com.dap.sequence.client.factory;


import com.dap.sequence.api.util.SeqKeyUtils;
import com.dap.sequence.client.core.DefaultSeqFlowEngine;
import com.dap.sequence.client.core.LocalSeqProducer;
import com.dap.sequence.client.core.LocalSerialSeqProducer;
...
public class SeqFlowEngineFactory {
    ...
    public static void loadEngine(SeqDesignPo seq) {
        ...
        // 连续性序列引擎构建
        AtomicReference<LocalSeqProducer> seqProducerReference = new AtomicReference<>();
        LocalSerialSeqProducer serialSeqProducer = new LocalSerialSeqProducer();
